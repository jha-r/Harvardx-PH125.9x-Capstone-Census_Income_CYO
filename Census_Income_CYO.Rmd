...
```{r workclass_income}
ggplot(census_data, aes(x = workclass, fill = income, color = income)) +
  
  # aes(workclass, count(workclass), fill=factor(income, levels=c("blue","white" )))) +
...
ggplot(census_data, aes(forcats::fct_reorder(workclass, as.numeric(income)), fill = income)) +
...
```{r education_income}
    ggplot(census_data, aes(x = education, fill = income, color = income)) +
       geom_bar(alpha = 0.8, position = "fill") +
       coord_flip() +
...
```{r maritalstatus_income}
    ggplot(census_data, aes(x = marital_status, fill = income, color = income)) +
       geom_bar(alpha = 0.8, position = "fill") +
      coord_flip() +    
...
```{r Race_income}
    ggplot(census_data, aes(x = race, fill = income, color = income)) +
      geom_bar(alpha = 0.8, position = "fill") +
      coord_flip()+
...
```{r Occupation_income}
    ggplot(census_data, aes(x = occupation, fill = income, color = income)) +
       geom_bar(alpha = 0.8, position = "fill") +
         coord_flip() +
...
```{r Sex_income}
    ggplot(census_data, aes(x = sex, fill = income, color = income)) +
       geom_bar(alpha = 0.8, position = "fill") +
         coord_flip() +
...
```{r country_income}
    ggplot(census_data, aes(x = native_country, fill = income, color = income)) +
       geom_bar(alpha = 0.8, position = "fill") +
         coord_flip() +
