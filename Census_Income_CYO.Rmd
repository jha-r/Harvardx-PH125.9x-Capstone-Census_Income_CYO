...
Before splitting the dataset, let's convert the variables to factors as they were converted to numerical/charater to do data analysis and wrangling step.
...
```{r log_model}
    ...
    #predicted_class <- ifelse(Prediction_log > log_model_acc, ">50K", "<=50K")
