...
It is closely followed by Support Vector Machine, k Nearest Neighbor; whereas, Random Forest Model and Decision Tree Model ranked at the least two positions with respect to the performance.
